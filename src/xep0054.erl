...
get_els({vcard_temp, _version, _fn, _n, _nickname,
	 _photo, _bday, _adr, _label, _tel, _email, _jabberid,
	 _mailer, _tz, _geo, _title, _role, _logo, _org,
	 _categories, _note, _prodid, _rev, _sort_string, _sound,
	 _uid, _url, _class, _key, _desc, _sub_els}) ->
    _sub_els.

set_els({vcard_temp, _version, _fn, _n, _nickname,
	 _photo, _bday, _adr, _label, _tel, _email, _jabberid,
	 _mailer, _tz, _geo, _title, _role, _logo, _org,
	 _categories, _note, _prodid, _rev, _sort_string, _sound,
	 _uid, _url, _class, _key, _desc, _},
	_sub_els) ->
    {vcard_temp, _version, _fn, _n, _nickname, _photo,
     _bday, _adr, _label, _tel, _email, _jabberid, _mailer,
     _tz, _geo, _title, _role, _logo, _org, _categories,
     _note, _prodid, _rev, _sort_string, _sound, _uid, _url,
     _class, _key, _desc, _sub_els}.
...
pp(vcard_temp, 30) ->
    [version, fn, n, nickname, photo, bday, adr, label, tel,
     ...
     uid, url, class, key, desc, sub_els];
pp(_, _) -> no.
...
records() ->
    [{vcard_name, 5}, {vcard_adr, 14}, {vcard_label, 8},
     ...
     {vcard_sound, 3}, {vcard_key, 2}, {vcard_temp, 30}].
...
decode_vcard_temp(__TopXMLNS, __Opts,
    ...
    {vcard_temp, Version, Fn, N, Nickname, Photo, Bday, Adr,
     ...
     Sort_string, Sound, Uid, Url, Class, Key, Desc, __Els}.
	...
	of
	  ...
	  decode_vcard_temp_els(__TopXMLNS, __Opts, _els, Mailer,
				...
				[decode_vcard_TEL(<<"vcard-temp">>, __Opts, _el)
				 | Tel],
				Label, Fn, Version, N, Photo, Logo, Geo, __Els);
      _ ->
	  decode_vcard_temp_els(__TopXMLNS, __Opts, _els, Mailer,
				Adr, Class, Categories, Desc, Uid, Prodid,
				Jabberid, Sound, Note, Role, Title, Nickname,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
	...
	of
	  ...
	  decode_vcard_temp_els(__TopXMLNS, __Opts, _els, Mailer,
				...
				Rev, Sort_string, Org, Bday, Key, Tz, Url,
				Email, Tel, Label, Fn, Version, N, Photo, Logo,
				decode_vcard_GEO(<<"vcard-temp">>, __Opts, _el),
				__Els);
      _ ->
	  decode_vcard_temp_els(__TopXMLNS, __Opts, _els, Mailer,
				Adr, Class, Categories, Desc, Uid, Prodid,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
	...
	of
	  ...
	  decode_vcard_temp_els(__TopXMLNS, __Opts, _els, Mailer,
				...
				Version, N, Photo, Logo, Geo, __Els);
      _ ->
	  decode_vcard_temp_els(__TopXMLNS, __Opts, _els, Mailer,
				Adr, Class, Categories, Desc, Uid, Prodid,
				Jabberid, Sound, Note, Role, Title, Nickname,
