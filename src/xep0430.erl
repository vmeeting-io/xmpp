...
decode_inbox_fin(__TopXMLNS, __Opts,
    ...
    Rsm = decode_inbox_fin_els(__TopXMLNS, __Opts, _els,
			       undefined),
    {Total, Unread, All_unread} =
	decode_inbox_fin_attrs(__TopXMLNS, _attrs, undefined,
			       undefined, undefined),
...
decode_inbox_fin_els(__TopXMLNS, __Opts,
	...
	of
	  ...
	  decode_inbox_fin_els(__TopXMLNS, __Opts, _els,
...
decode_inbox_fin_attrs(__TopXMLNS,
		       ...
		       All_unread) ->
    decode_inbox_fin_attrs(__TopXMLNS, _attrs, _val, Unread,
			   All_unread);
decode_inbox_fin_attrs(__TopXMLNS,
		       [{<<"unread">>, _val} | _attrs], Total, _Unread,
		       All_unread) ->
    decode_inbox_fin_attrs(__TopXMLNS, _attrs, Total, _val,
			   All_unread);
decode_inbox_fin_attrs(__TopXMLNS,
		       [{<<"all-unread">>, _val} | _attrs], Total, Unread,
		       _All_unread) ->
    decode_inbox_fin_attrs(__TopXMLNS, _attrs, Total,
			   Unread, _val);
...
encode_inbox_fin({inbox_fin, Total, Unread, All_unread,
		  Rsm},
		 __TopXMLNS) ->
    __NewTopXMLNS =
...
decode_inbox_fin_attr_unread(__TopXMLNS, _val) ->
    case catch dec_int(_val, 0, infinity) of
      {'EXIT', _} ->
	  erlang:error({xmpp_codec,
			{bad_attr_value, <<"unread">>, <<"fin">>, __TopXMLNS}});
      _res -> _res
    end.
...
decode_inbox_entry_attrs(__TopXMLNS,
    ...
    decode_inbox_entry_attrs(__TopXMLNS, _attrs, _val, Jid,
			     Id);
decode_inbox_entry_attrs(__TopXMLNS,
			 [{<<"jid">>, _val} | _attrs], Unread, _Jid, Id) ->
    decode_inbox_entry_attrs(__TopXMLNS, _attrs, Unread,
			     _val, Id);
decode_inbox_entry_attrs(__TopXMLNS,
...
decode_inbox_query(__TopXMLNS, __Opts,
    ...
    Rsm = decode_inbox_query_els(__TopXMLNS, __Opts, _els,
				 undefined),
    {inbox_query, Rsm}.
